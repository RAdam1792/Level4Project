...
<table>
<tr>
<cfform action = "challengeAuth3.cfm?image=1" method = "post">
...
<cfform action = "challengeAuth3.cfm?image=2" method = "post">
...
<cfform action = "challengeAuth3.cfm?image=3" method = "post">
...
<tr>
<cfform action = "challengeAuth3.cfm?image=4" method = "post">
...
<cfform action = "challengeAuth3.cfm?image=5" method = "post">
...
<cfform action = "challengeAuth3.cfm?image=6" method = "post">
...
<tr>
<cfform action = "challengeAuth3.cfm?image=7" method = "post">
...
<cfform action = "challengeAuth3.cfm?image=8" method = "post">
...
<cfform action = "challengeAuth3.cfm?image=9" method = "post">
